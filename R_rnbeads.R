...
setwd("~/Analises R/r_array_mouse_013122/lps_wild_vs_saline")
save.image(file = "lps_wild_vs_saline.RData")
...
data.dir <- "~/Analises R/r_array_mouse_013122/lps_wild_vs_saline"
idat.dir <- file.path(data.dir, "idat_files")
sample.annotation <- file.path(data.dir, "sample_annotation.csv")
# Directory where the output should be written to
analysis.dir <- "~/Analises R/r_array_mouse_013122/lps_wild_vs_saline"
...
save.rnb.set(rnb.set, path="~/Analises R/r_array_mouse_013122/lps_wild_vs_saline/data_analysis/rnb.set.norm", archive=F)
rnb.set <- result$rnb.set
...
save.rnb.set(rnb.set, path="~/Analises R/r_array_mouse_013122/lps_wild_vs_saline/data_analysis/rnb.set.norm_2", archive=F)

nrow(meth(rnb.set.norm))

#running the exploratory analysis module
rnb.run.exploratory(rnb.set.norm, report.dir)
save.rnb.set(rnb.set, path="~/Analises R/r_array_mouse_013122/lps_wild_vs_saline/data_analysis/rnb.set.expl", archive=F)
...
unlink(fileNameOut2)
write_xlsx(x, path = "~/Analises R/r_array_mouse_013122/lps_wild_vs_saline/bvalue_norm.xlsx")
...
write_xlsx(de.sites.annot_nodupli, "Differential_Methylation_cpg_sites.xlsx" )
